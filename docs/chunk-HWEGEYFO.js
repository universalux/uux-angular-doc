import{a as C}from"./chunk-NI6Y3Y6G.js";import{e as c,h as u}from"./chunk-FIO25GLS.js";import"./chunk-WYHA5YSP.js";import{Bb as p,Cb as h,Db as b,Ha as d,Ia as o,Ja as t,Ka as a,Q as m,ba as l,cb as e,la as i,sa as g}from"./chunk-DJ42HLST.js";var f={installationCode_1:{language:"bash",code:"npm install ng-content-card"},installationCode_2:{language:"bash",code:"npm install ng-content-card@v19-lts"},installationCode_3:{language:"bash",code:"npm install ng-content-card@v18-lts"},overviewCode_1:{language:"html",code:`
    ...
    `}};var y={funcTable_1:{tableHeader:c.slotsTableHeader,tableRows:[["card-header","Content to show in the header"],["card-image","Main image section"],["card-body","Main body content"],["card-footer","Footer content"],["absolute-content","Extra content with position absolute"]]},ioTable_1:{tableHeader:c.inputTableHeader,tableRows:[["animation","Entrance animation effect: 'translateY', 'fadeIn', 'none'","'translateY'"],["hover","Hover effect: 'scale', 'tone', 'both', 'none'","'scale'"],["shadow","Enable/disable card shadow","true"]]},styTable_1:{tableHeader:c.varTableHeader,tableRows:[["--card-bg","Background color of the entire card","white","General"],["--card-fg","Foreground (text) color of the card","black","General"],["--card-section-padding","Internal padding for each section (header, body, footer)","16px","General"],["--card-image-padding-x","Horizontal padding for the image container","0px","General"],["--card-footer-border-top","Top border of the footer section","0px solid currentColor","General"],["--card-hover-velocity","Transition duration applied on hover",".3s","Hover"],["--card-hover-scale","Scale factor when hovering (if hover='scale')","1.03","Hover"],["--card-hover-bg","Background color on hover (if hover='color' or 'both')","color-mix(in srgb, var(--card-bg) 70%, #999999 30%)","Hover"],["--card-hover-fg","Foreground/text color on hover (if hover='color' or 'both')","var(--card-fg)","Hover"],["--card-animation-delay","Delay before the entrance animation starts","0s","Animation"],["--card-animation-velocity","Duration of the entrance animation","1s","Animation"],["--card-shadow","Box-shadow applied when shadow=true","3px 3px 20px color-mix(in srgb, var(--card-fg) 60%, #999999 40%)","Shadow"],["--card-header-bg","Background color of the header section","transparent","Sections"],["--card-image-bg","Background color of the image section","transparent","Sections"],["--card-body-bg","Background color of the body section","transparent","Sections"],["--card-footer-bg","Background color of the footer section","transparent","Sections"],["--card-header-text-color","Text color inside the header section","inherit","Sections"],["--card-body-text-color","Text color inside the body section","inherit","Sections"],["--card-footer-text-color","Text color inside the footer section","inherit","Sections"]]}};var v=class s{docCode=l(f);docTables=l(y);metaTagsService=m(p);ngOnInit(){this.metaTagsService.setMetaTags({title:"Content Card \u2022 UUX Angular",description:"UUX Content Card component documentation",image:"/components/content-card",url:"/components/content-card/documentation",type:"article"})}static \u0275fac=function(r){return new(r||s)};static \u0275cmp=g({type:s,selectors:[["app-content-card-doc"]],decls:105,vars:19,consts:[["sectionCode","intro"],["sectionCode","inst"],[3,"language","code"],["sectionCode","ovw"],["sectionCode","func"],[3,"tableData"],["sectionCode","io"],["sectionCode","sty"],["sectionCode","acc"]],template:function(r,n){r&1&&(a(0,"doc-section-title",0),o(1,"p")(2,"em"),e(3,"ng-content-card"),t(),e(4," is a "),o(5,"em"),e(6,"standalone, reusable and customizable component"),t(),e(7,` for Angular 18, 19 and 20.
